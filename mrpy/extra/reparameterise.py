...
class ReparameteriseSampleLike(ReparameteriseMRP, lk.SampleLike):
    """
    ...
    def this_jacobian(self):
        ...
        return np.array([np.dot(j, self._dtheta_dp1()), np.dot(j, self._dtheta_dp2()),
                         np.dot(j, self._dtheta_dp3()),self.jacobian[3]])
    ...
    def this_hessian(self):
        ...
        out = np.array([[h11, h12, h13,0], [h12, h22, h23,0], [h13, h23, h33,0],[0,0,0,self.hessian[3,3]]])
        return out
...
class ReparameteriseCurveLike(ReparameteriseSampleLike, lk.CurveLike):
    """
    An extension of :class:`ReparameteriseMRP` which adds necessary methods for calculating
...
class _AP1PerObj(_Ap1MRP, ReparameteriseSampleLike):
    pass
...
class AP1Sample(Ap1MRP, ReparameteriseSampleLike):
    pass
...
class GG2Sample(GG2MRP, ReparameteriseSampleLike):
    def _dtheta_dp1(self, **kwargs):
...
class GG2Curve(GG2Sample, ReparameteriseCurveLike):
    pass
...
class GG3Sample(GG3MRP, ReparameteriseSampleLike):
    def _dtheta_dp1(self, **kwargs):
...
class GG3Curve(GG3Sample, ReparameteriseCurveLike):
    pass
...
class HTSample(HTMRP, ReparameteriseSampleLike):
    def _dtheta_dp1(self, **kwargs):
        return np.array([1.0, 0, 0])
...
class HTCurve(HTSample, ReparameteriseCurveLike):
    pass