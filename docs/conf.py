# -*- coding: utf-8 -*-
#
# mrpy documentation build configuration file, created by
...
release = find_version("..","mrpy", "__init__.py")
...
latex_documents = [
  (master_doc, 'mrpy.tex', u'mrpy Documentation',
...
man_pages = [
    (master_doc, 'mrpy', u'mrpy Documentation',
     [author], 1)
]
...
texinfo_documents = [
  (master_doc, 'mrpy', u'mrpy Documentation',
   author, 'mrpy', 'One line description of project.',
   'Miscellaneous'),
]
